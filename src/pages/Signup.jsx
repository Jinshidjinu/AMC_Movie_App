        ...
        <div className='bg-gray-200 flex items-center rounded-2xl shadow-lg max-w-3xl p-5 md:ml-[370px] mt-12'>
           <div className='md:w-1/2 px-16'>
            ...
            <form action="" className='flex flex-col gap-2'>
              ...
              <input className='p-2 mt-8 rounded-xl border' type="number" name='phone' placeholder='phone' />
              ...
              <input className='p-2 mt-8 rounded-xl border w-full' type="password" name='password' placeholder='ConfirmPassword'  />
              <button className='bg-red-900 rounded-xl text-white py-2 hover:scale-110 duration-300 mt-4'>Sign Up</button>
            </form>

...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-black min-h-[45px] max-w-[1600px] md:mx-auto flex justify-between items-center">
      ...
      <div className={nav ? 'fixed z-10 top-[45px] left-0 right-0 h-screen bg-black ease-out duration-500' : 'fixed top-[-100%]'}>

    ...
    <div className="flex flex-col bg-black">
      ...
      <div className="flex flex-wrap gap-6 ">
        {movies.map((movie) => (
          <div
            key={movie.name}
            className="flex flex-col items-center w-[280px] h-[500px] p-5 bg-black rounded-lg transition-all duration-150 hover:scale-110"
          >
            ...
            <div className="flex flex-col justify-center items-center mt-5">
              <h1 className="text-white font-bold font-serif">{movie.name}</h1>
